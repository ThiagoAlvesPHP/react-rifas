...
export function MenuLeft(props) {
    ...
    function Mode() {
        let checkbox = refMode.current.children[0].children[0].children[0]
        props.setMode((checkbox.checked)?true:false);
    }
        ...
        <div className={`menu-left ${props.menu == 1  ? 'active' :''}`}>
            ...
            <nav className='navbar'>
                <ul className="list">
                    ...
                    <li className="link-primary">
                        <RiShieldUserFill /> <span className="text">Usuários</span>
                        <div className="submenu">
                            <Link to={``} className="link">Cadastrar</Link>
                            <Link to={``} className="link">Listar</Link>
                        </div>
                    </li>
                    <li className="link-primary">
                        <RiUserFollowFill /> 
                    ...
                    <li className="link-primary">
                        ...
                        <div className="submenu">
                            <Link to={``} className="link">Relatorio</Link>
                            <Link to={``} className="link">A Pagar</Link>
                            <Link to={``} className="link">À Receber</Link>
                        </div>
                    </li>
                    <li className="link-primary">
                        <RiMailSendFill /> 
                    ...
                    <li className="link-primary">
                        ...
                        <div className="submenu">
                            ...
                            <Link to={``} className="link">Serviços</Link>
                        </div>
                    </li>
                    <li className="link-primary">
                        <RiStackshareLine /> 
                        ...
                        <div className="submenu">
                            <Link to={``} className="link">Tipo de Saída</Link>
                            <Link to={``} className="link">Forma de Pagamento</Link>
                        </div>
                    </li>
                </ul>
            </nav>
